create view vw_planet_polygon as
select
osm_id,
access,
...
psql --db gis -c "\copy (select * from vw_planet_polygon) to stdout WITH CSV HEADER" | pigz > /home/rzwitch/sandisk2TB_860/planet_osm_polygon.csv.gz
